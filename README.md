...
This is a detailed walkthrough of the process of turning your 3D-printer into a wireless 3D-printer using a Raspberry Pi. This tutorial is for people of all experience levels. You can follow the tutorial regardless weather you have the same printer and Raspberry Pi. Just try to have fun and keep everything neat.
...
>> - Make sure the enclosures and arm will fit your equipment before wasting precious filament.<br/>
>> - Slice and print the parts according to your preferences (links in the resources section contain the thingiverse 3D design model parts).
>> - Depending on your camera position preference, you might want to print more links. With 5 links, the camera can be positioned in-front of the print bed. Keep in mind the more links you print the shakier the camera will be.
>> 
...
>>>> <p> - You could pass the ribbon cable through the Prusa Einsy board compartment (the metal compartment near the Z-axis motor). But be careful as you could short the Einsy board if you use a metal probe to fish the ribbon cable at the other side. I reccommend using a piece of filament. </p>
...
>> 
>> - Place Pi in Case, release the cable lock on the camera port by gently pulling on both sides of the black clip. Then connect the ribbon cable to the camera port so the contacts of the cable are touching the contacts of the Pi port:
>> 
...
>> - You should see something similar after you are done:
...
>> - If you are comfortable configuring it, feel free to configure according to your preferences. Here are my configurations and why:
...
>>> + Check "Configure wireless LAN" and enter your network's name and password. This will allow the Pi to connect to your router wirelessly. Make sure you enter that information correctly because changing them is somewhat of a hassle, it is easier to just overwrite the SD-Card and re-install the OS in order to change the network settings.
